...
@Component({
  selector: 'app-edit-governing-bodies-contact-dialog',
  templateUrl: './edit-governing-bodies-contact-dialog.component.html',
  styleUrls: ['./edit-governing-bodies-contact-dialog.component.scss']
})
export class EditGoverningBodiesContactDialogComponent {
   ...
   */
  constructor(
    public dialogRef: MatDialogRef<EditGoverningBodiesContactDialogComponent>,
