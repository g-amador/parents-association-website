...
import { EditEventFormDialogComponent } from './edit-event-form-dialog/edit-event-form-dialog.component';
...
export class EventsComponent implements OnInit {
  ...
  /**
   * Constructor for EventsComponent.
   *
   ...
   * Loads initial events data and checks the current route for admin status.
   */
  async ngOnInit() {
