...
@Component({
  selector: 'app-news-and-information-archive-sidebar',
  templateUrl: './news-and-information-archive-sidebar.component.html',
  styleUrls: ['./news-and-information-archive-sidebar.component.scss']
})
export class NewsAndInformationArchiveSidebarComponent implements OnInit {
  /**
  ...
  /**
   * Constructor for the NewsAndInformationArchiveSidebarComponent.
